        ...
        <?php while ($posts->have_posts()) : $posts->the_post(); ?>
            ...
            <div class="<?php echo implode(' ', get_post_class('wabbr-post')); ?>">
                <?php if ($show_thumbnail) : ?>
                    echo '<a href="<?php echo get_permalink(); ?>" title="<?php echo the_title_attribute(['echo' => false]); ?>" class="wabbr-post-link"><?php echo get_the_post_thumbnail(get_the_ID(), $thumbnail_size, ['class' => 'wabbr-post-img '.$thumbnail_class]); ?></a>
                <?php endif; ?>
