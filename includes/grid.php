        ...
        foreach ($sizes as $size) {
            if (preg_match('/^[0-9]{1,2}\/[0-9]{1,2}$/', $size)) {
                switch ($size) {
                    ...
                    case '5/10':
                    case '6/12':
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-6', 'col-lg-6'));
                    break;
                    ...
                    case '3/9':
                    case '4/12':
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-4', 'col-lg-4'));
                    break;

                    case '1/4':
                    case '2/8':
                    case '3/12':
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-3', 'col-lg-3'));
                    break;

                    case '1/6':
                    case '2/12':
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-2', 'col-lg-2'));
                    break;

                    case '2/3':
                    case '4/6':
                    case '8/12':
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-8', 'col-lg-8'));
                    break;

                    case '3/4':
                    case '6/8':
                    case '9/12':
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-9', 'col-lg-9'));
                    break;

                    case '5/6':
                    case '10/12':
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-10', 'col-lg-10'));
                    break;

                    default:
                        $classes = array_merge($classes, array('col-xs-12', 'col-sm-12', 'col-md-12', 'col-lg-12'));
                    break;
                }
            } else {
                $classes[] = $size;
